...
public class ResultService extends AbstractTransactionBasedService<Result> {
    /**
     * Logger.
     */
    private Logger logger = LogManager.getLogger("main");

    ResultService(final Transaction newTransaction) {
    ...
    public static final Integer IDENTIFIERS = 1;
    static {
        SPECIFICATION_PROVIDER.put(IDENTIFIERS,
                ResultService::findByIdentifiers);
    }
